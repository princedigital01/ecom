...
const Bin = ({ size, className, color, fill, strokeWidth, ...props }) => {
    return (

        <svg className={className} width={size || "22"} height={size || "22"} viewBox="0 0 22 22" fill={fill || `none`} xmlns="http://www.w3.org/2000/svg">
